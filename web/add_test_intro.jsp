...
<div class="tab-content">
    <div class="container">
        <form class="col-form-label" action="test_intro_insert" method="post">
            <div class="row">

                <div class="form-group col-9">
                    <label for="tname"><b>Test Name</b></label>
                    <input type="text" class="form-control col-9" id="tname" name="test_name">

                </div>
                <div class="form-group col-9">
                    <label ><b>Test Duration</b></label><br>

                    <label for="Hours"><b>Hours : </b></label>
                    <select class="form-control col-3" name="Hours" id="Hours">
                            <%
                                int i;
                                for(i=0;i<24;i++)
                                {
                    ...
                    <select class="form-control col-3" name="Minutes" id="Minutes">
                        <%
                            for(i=0;i<=59;i++)
                            {
                        %>
                    ...
                    <select class="form-control col-3" name="Seconds" id="Seconds">
                        <%
                            for(i=0;i<=59;i++)
                            {
                        %>
                ...
                <div class="form-group col-9">
                    ...
                    <input type="text" class="form-control col-9" id="marks" name="test_mark">

                </div>
                <div class="form-group col-9">
                    <label for="number"><b>Number of Questions to be Displayed</b></label>
                    <input type="text" class="form-control col-9" id="number" name="test_noq">

                </div>
                <div class="form-group col-9">
                    <label for="tnoq"><b>Total Number of Questions</b></label>
                    <input type="text" class="form-control col-9" id="tnoq" name="total_noq">
