...
<br>
       ...
       <div class="tab-content">
        <div class="container">
            <form class="col-form-label" action="concept_insert" method="post">
            <div class="row">
                ...
                <div class="form-group text-center col-3">
                    <br>
                    <button type="submit" id="ConceptAdd" class="btn btn-primary" >Add</button>
                </div>
            </div>
                <br><br>
                <div class="container">
                    ...
                    <div class="form-group col-9" >
                        <textarea  name="concept_text" value="Add Text here">
                            </textarea>
                    </div>
                </div>
            </form>
